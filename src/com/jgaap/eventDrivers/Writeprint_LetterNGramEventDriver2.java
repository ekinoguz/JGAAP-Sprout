...
public class Writeprint_LetterNGramEventDriver2 extends CharacterNGramEventDriver {
	
	@Override
	public String displayName() {
		return "_WP_Letter N-Grams N=2";
	}

	@Override
	public String tooltipText() {
		return "Groups of N successive letters, N = 2";
	}
