...
import com.jstylo.FrequencyEventsExtended;
 ...
 */
public class Writeprint_ListEventDriver3 extends EventDriver {
	...
	private EventDriver underlyingEvents = new CharacterEventDriver();
	private String filename = "com/jstylo/resources/writeprints_punctuation.txt";
	...
	@Override
	public EventSet createEventSet(char[] ds) throws EventGenerationException {
				...
				if (c < 0) {
					...
					if (!whiteList) {
						for (int k=0; k<numEvents.get(e1); k++)
							newEs.addEvent(new Event(e1,this));
					}
